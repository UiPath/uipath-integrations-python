...
def generate_script(target_directory):
    ...
    template_google_adk_json_path = os.path.join(
        os.path.dirname(__file__), "_templates/google_adk.json.template"
    )
...
def google_adk_new_middleware(name: str) -> MiddlewareResult:
    """Middleware to create demo Google ADK agent"""
