...
class GoogleADKAgentLoader:
    ...
    def from_path_string(cls, name: str, file_path: str) -> Self:
        """
        Create a GoogleADKAgentLoader from a path string.
        ...
        Returns:
            An instance of GoogleADKAgentLoader.
        """
        if ":" not in file_path:
            raise UiPathGoogleADKRuntimeError(
                code=UiPathGoogleADKErrorCode.CONFIG_INVALID,
    ...
    async def load(self) -> BaseAgent:
        ...
        Raises:
            UiPathGoogleADKRuntimeError: If loading fails
        """
        ...
        if not abs_file_path.startswith(cwd):
            raise UiPathGoogleADKRuntimeError(
                code=UiPathGoogleADKErrorCode.AGENT_VALUE_ERROR,
        ...
        if not os.path.exists(abs_file_path):
            raise UiPathGoogleADKRuntimeError(
                code=UiPathGoogleADKErrorCode.AGENT_NOT_FOUND,
        ...
        if not isinstance(agent, BaseAgent):
            raise UiPathGoogleADKRuntimeError(
                code=UiPathGoogleADKErrorCode.AGENT_TYPE_ERROR,
    ...
    def _import_module(self, abs_file_path: str) -> Any:
        ...
        if not spec or not spec.loader:
            raise UiPathGoogleADKRuntimeError(
                code=UiPathGoogleADKErrorCode.AGENT_IMPORT_ERROR,
        ...
        try:
            ...
            raise UiPathGoogleADKRuntimeError(
                code=UiPathGoogleADKErrorCode.AGENT_LOAD_ERROR,
